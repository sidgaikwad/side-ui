    ...
    <main className="min-h-screen relative bg-[#030303] overflow-hidden selection:bg-emerald-500/30">
      ...
      <section className="relative py-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          {/* GRID LAYOUT: Info on Left, Terminal on Right */}
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-4 space-y-5">
              <FadeIn delay={400} direction="left">
                {/* Feature 1 */}
                <div className="p-5 rounded-lg border border-white/5 bg-white/5 backdrop-blur-md hover:border-pink-500/30 transition-colors group">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="p-2 rounded bg-pink-500/10 text-pink-400 group-hover:text-pink-300">
                      <svg
                        className="w-5 h-5"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <h3 className="font-semibold text-white">Any Terminal</h3>
                  </div>
                  <p className="text-sm text-slate-400">
                    Accessible from any device with an SSH client. No browser
                    needed.
                  </p>
                </div>
                ...
                <div className="p-5 rounded-lg border border-white/5 bg-white/5 backdrop-blur-md hover:border-purple-500/30 transition-colors group">
                  ...
                  <p className="text-sm text-slate-400">
                    End-to-end encrypted connection using standard SSHv2
                    protocols.
                  </p>
                </div>

                {/* Feature 3 */}
                <div className="p-5 rounded-lg border border-white/5 bg-white/5 backdrop-blur-md hover:border-indigo-500/30 transition-colors group">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="p-2 rounded bg-indigo-500/10 text-indigo-400 group-hover:text-indigo-300">
                      <svg
                        className="w-5 h-5"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <h3 className="font-semibold text-white">Zero Install</h3>
                  </div>
                  <p className="text-sm text-slate-400">
                    Just one command to start. No npm dependencies required on
                    the client.
                  </p>
                </div>
              </FadeIn>
