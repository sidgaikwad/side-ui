...
export function Navigation() {
  ...
  const links = [
    ...
    { href: "http://localhost:3001/docs", label: "Docs", external: true },
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/" className="group flex items-center gap-3">
          <div className="relative flex h-8 w-8 items-center justify-center rounded-lg bg-white overflow-hidden transition-transform group-hover:scale-110">
            <span className="text-lg font-bold text-black relative z-10">S</span>
            ...
            <span className="absolute text-lg font-bold text-white opacity-0 group-hover:opacity-100 transition-opacity z-20">S</span>
          </div>
        ...
        <nav className="flex items-center gap-1">
          ...
          >
            <svg className="h-4 w-4 transition-transform group-hover:rotate-12" fill="currentColor" viewBox="0 0 24 24">
