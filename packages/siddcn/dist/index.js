...
var SimpleButton = ({ label = "Button" }) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, { borderStyle: theme.borderStyle, borderColor: theme.colors.border, paddingX: 2 }, /* @__PURE__ */ React.createElement(Text, { color: theme.colors.text }, label));
};
var PrimaryButton = ({ label = "Primary" }) => {
  const theme = getTheme();
  return /* @__PURE__ */ React.createElement(Box, { borderStyle: "double", borderColor: theme.colors.primary, paddingX: 2 }, /* @__PURE__ */ React.createElement(Text, { bold: true, color: theme.colors.primary }, label));
};
var DangerButton = ({ label = "Delete" }) => {
  const theme = getTheme();
  return /* @__PURE__ */ React.createElement(Box, { borderStyle: theme.borderStyle, borderColor: theme.colors.error, paddingX: 2 }, /* @__PURE__ */ React.createElement(Text, { bold: true, color: theme.colors.error }, label));
};
...
var LinearProgress = ({ value, max = 100, animated = true }) => {
  ...
  return /* @__PURE__ */ React2.createElement(Box2, { flexDirection: "column" }, /* @__PURE__ */ React2.createElement(Text2, null, /* @__PURE__ */ React2.createElement(Text2, { color: theme.colors.success }, "\u2588".repeat(filled)), /* @__PURE__ */ React2.createElement(Text2, { dimColor: true }, "\u2591".repeat(empty)), " ", /* @__PURE__ */ React2.createElement(Text2, { color: theme.colors.primary }, percentage, "%")), /* @__PURE__ */ React2.createElement(Text2, { dimColor: true }, "Linear Progress Bar (Animated)"));
};
var CircularProgress = ({ percentage, animated = true }) => {
  ...
  return /* @__PURE__ */ React2.createElement(Box2, { flexDirection: "column" }, /* @__PURE__ */ React2.createElement(Box2, null, /* @__PURE__ */ React2.createElement(Text2, { color: theme.colors.success }, /* @__PURE__ */ React2.createElement(Spinner, { type: "dots" })), /* @__PURE__ */ React2.createElement(Text2, null, " "), /* @__PURE__ */ React2.createElement(Text2, { color: theme.colors.primary }, currentPercentage, "%")), /* @__PURE__ */ React2.createElement(Text2, { dimColor: true }, "Circular Progress (Animated)"));
};
var StepProgress = () => {
  const theme = getTheme();
  ...
  return /* @__PURE__ */ React2.createElement(Box2, { flexDirection: "column" }, /* @__PURE__ */ React2.createElement(Box2, null, [0, 1, 2, 3].map((step, idx) => /* @__PURE__ */ React2.createElement(React2.Fragment, { key: step }, idx > 0 && /* @__PURE__ */ React2.createElement(Text2, { color: step <= currentStep ? theme.colors.success : theme.colors.dimText }, " \u2501\u2501 "), /* @__PURE__ */ React2.createElement(Text2, { color: step <= currentStep ? stepColors[step] : theme.colors.dimText }, step < currentStep ? "\u2713" : step === currentStep ? "\u25CF" : "\u25CB")))), /* @__PURE__ */ React2.createElement(Box2, { marginTop: 1 }, ["Step 1", "Step 2", "Step 3", "Step 4"].map((label, idx) => /* @__PURE__ */ React2.createElement(
    Text2,
    {
      key: idx,
    ...
    label,
    idx < 3 && "    "
  ))), /* @__PURE__ */ React2.createElement(Box2, { marginTop: 1 }, /* @__PURE__ */ React2.createElement(Text2, { dimColor: true }, "Multi-step Progress (Animated)")));
};
...
var StatusBadge = ({ status = "success" }) => {
  ...
  return /* @__PURE__ */ React3.createElement(Box3, null, /* @__PURE__ */ React3.createElement(Box3, { borderStyle: theme.borderStyle, borderColor: colors[status], paddingX: 1 }, /* @__PURE__ */ React3.createElement(Text3, { color: colors[status] }, labels[status])));
};
var CountBadge = ({ count = 42 }) => {
  const theme = getTheme();
  return /* @__PURE__ */ React3.createElement(Box3, null, /* @__PURE__ */ React3.createElement(Box3, { borderStyle: theme.borderStyle, borderColor: theme.colors.primary, paddingX: 1 }, /* @__PURE__ */ React3.createElement(Text3, { color: theme.colors.primary, bold: true }, count)));
};
var DotBadge = ({ color }) => {
  const theme = getTheme();
  const dotColor = color || theme.colors.success;
  return /* @__PURE__ */ React3.createElement(Box3, null, /* @__PURE__ */ React3.createElement(Text3, { color: dotColor }, "\u25CF"), /* @__PURE__ */ React3.createElement(Text3, null, " Online"));
};
...
var BarChart = () => {
  ...
  return /* @__PURE__ */ React4.createElement(Box4, { flexDirection: "column" }, /* @__PURE__ */ React4.createElement(Text4, { color: "cyan", bold: true }, "Bar Chart"), /* @__PURE__ */ React4.createElement(Box4, { marginTop: 1, flexDirection: "column" }, data.map((item, idx) => {
    const barLength = Math.round(item.value / maxValue * 20);
    return /* @__PURE__ */ React4.createElement(Box4, { key: idx }, /* @__PURE__ */ React4.createElement(Text4, null, item.label, ": "), /* @__PURE__ */ React4.createElement(Text4, { color: "green" }, "\u2588".repeat(barLength)), /* @__PURE__ */ React4.createElement(Text4, null, " ", item.value));
  })));
};
var LineChart = () => {
  const data = [10, 20, 15, 30, 25, 35, 32];
  return /* @__PURE__ */ React4.createElement(Box4, { flexDirection: "column" }, /* @__PURE__ */ React4.createElement(Text4, { color: "cyan", bold: true }, "Line Chart"), /* @__PURE__ */ React4.createElement(Box4, { marginTop: 1 }, /* @__PURE__ */ React4.createElement(Text4, { color: "green" }, data.map((val, idx) => {
    const prev = idx > 0 ? data[idx - 1] : val;
    if (val > prev) return "\u2571";
    if (val < prev) return "\u2572";
    return "\u2500";
  }).join(""))), /* @__PURE__ */ React4.createElement(Box4, null, /* @__PURE__ */ React4.createElement(Text4, { dimColor: true }, data.map((val) => ` ${val}`).join(" "))));
};
...
var FileTree = ({ data, onSelect }) => {
  ...
  const [expanded, setExpanded] = useState2(/* @__PURE__ */ new Set([getNodeId(data, 0)]));
  ...
  return /* @__PURE__ */ React5.createElement(Box5, { flexDirection: "column" }, /* @__PURE__ */ React5.createElement(Box5, { marginBottom: 1 }, /* @__PURE__ */ React5.createElement(Text5, { dimColor: true }, "Showing "), /* @__PURE__ */ React5.createElement(Text5, { color: theme.colors.primary }, totalDirs), /* @__PURE__ */ React5.createElement(Text5, { dimColor: true }, " folders, "), /* @__PURE__ */ React5.createElement(Text5, { color: theme.colors.primary }, totalFiles), /* @__PURE__ */ React5.createElement(Text5, { dimColor: true }, " files")), /* @__PURE__ */ React5.createElement(Box5, { marginBottom: 1 }, /* @__PURE__ */ React5.createElement(Text5, { color: theme.colors.border }, "\u2500".repeat(48))), /* @__PURE__ */ React5.createElement(Box5, { flexDirection: "column" }, flatList.map((item, index) => {
    ...
    return /* @__PURE__ */ React5.createElement(Box5, { key: item.id }, /* @__PURE__ */ React5.createElement(Text5, { color: isSelected ? theme.colors.primary : theme.colors.text, bold: isSelected }, isSelected ? "> " : "  "), /* @__PURE__ */ React5.createElement(Text5, { dimColor: true }, indent), /* @__PURE__ */ React5.createElement(Text5, { color: nameColor }, icon), /* @__PURE__ */ React5.createElement(
      Text5,
      {
      ...
      item.node.name
    ), item.node.meta && /* @__PURE__ */ React5.createElement(Text5, { dimColor: true }, "  ", item.node.meta));
  })), /* @__PURE__ */ React5.createElement(Box5, { marginTop: 1 }, /* @__PURE__ */ React5.createElement(Text5, { color: theme.colors.border }, "\u2500".repeat(48))), flatList[cursor] && /* @__PURE__ */ React5.createElement(Box5, { marginTop: 1 }, /* @__PURE__ */ React5.createElement(Text5, { dimColor: true }, "Selected: "), /* @__PURE__ */ React5.createElement(Text5, { color: theme.colors.primary }, flatList[cursor].isDir ? "\u{1F4C1} " : "\u{1F4C4} ", flatList[cursor].node.name)), /* @__PURE__ */ React5.createElement(Box5, { marginTop: 1 }, /* @__PURE__ */ React5.createElement(Text5, { dimColor: true }, "\u2191\u2193 Navigate   \u2192 Expand   \u2190 Collapse   Enter Toggle")));
};
var DataTree = ({ data, onSelect }) => {
  ...
  return /* @__PURE__ */ React5.createElement(Box5, { flexDirection: "column" }, flatList.map((item, index) => {
    const isSelected = index === cursor;
    const indent = "  ".repeat(item.depth);
    return /* @__PURE__ */ React5.createElement(Box5, { key: item.id }, /* @__PURE__ */ React5.createElement(Text5, { color: isSelected ? theme.colors.primary : theme.colors.text }, isSelected ? "\u25CF " : "\u25CB "), /* @__PURE__ */ React5.createElement(Text5, null, indent), /* @__PURE__ */ React5.createElement(
      Text5,
      {
...
var Tabs = ({
  ...
  return /* @__PURE__ */ React6.createElement(Box6, { flexDirection: "column" }, /* @__PURE__ */ React6.createElement(Box6, null, tabs.map((tab, index) => {
  ...
  })), /* @__PURE__ */ React6.createElement(Box6, { marginY: 1 }, /* @__PURE__ */ React6.createElement(Text6, { color: theme.colors.border }, "\u2500".repeat(60))), /* @__PURE__ */ React6.createElement(
    Box6,
    {
  ...
  ), /* @__PURE__ */ React6.createElement(Box6, { marginTop: 1, justifyContent: "center" }, tabs.map((tab, index) => /* @__PURE__ */ React6.createElement(
    Text6,
    {
      key: tab.id,
    ...
    tab.icon || "\u25CF",
    index < tabs.length - 1 && "   "
  ))), /* @__PURE__ */ React6.createElement(Box6, { marginTop: 1, justifyContent: "center" }, /* @__PURE__ */ React6.createElement(Text6, { dimColor: true }, "\u2190 \u2192 Navigate   1-", tabs.length, " Quick Switch   Tab Cycle")));
};
var DashboardTab = () => {
  const theme = getTheme();
  const stats = [
  ...
  return /* @__PURE__ */ React6.createElement(Box6, { flexDirection: "column" }, /* @__PURE__ */ React6.createElement(Text6, { bold: true, color: theme.colors.primary }, "Dashboard Overview"), /* @__PURE__ */ React6.createElement(Box6, { marginTop: 1, flexDirection: "column" }, stats.map((stat, idx) => /* @__PURE__ */ React6.createElement(Box6, { key: idx, marginBottom: 1 }, /* @__PURE__ */ React6.createElement(Text6, { bold: true, color: theme.colors.secondary }, stat.value.padEnd(10)), /* @__PURE__ */ React6.createElement(Text6, null, stat.label.padEnd(18)), /* @__PURE__ */ React6.createElement(Text6, { color: stat.positive ? theme.colors.success : theme.colors.error }, stat.change)))), /* @__PURE__ */ React6.createElement(Box6, { marginTop: 1 }, /* @__PURE__ */ React6.createElement(Text6, { dimColor: true }, "Real-time metrics updated every minute")));
};
var AnalyticsTab = () => {
  const theme = getTheme();
  const data = [
  ...
  return /* @__PURE__ */ React6.createElement(Box6, { flexDirection: "column" }, /* @__PURE__ */ React6.createElement(Text6, { bold: true, color: theme.colors.primary }, "Platform Analytics"), /* @__PURE__ */ React6.createElement(Box6, { marginTop: 1, flexDirection: "column" }, data.map((item, idx) => {
    const barWidth = Math.floor(item.value / maxVal * 30);
    return /* @__PURE__ */ React6.createElement(Box6, { key: idx }, /* @__PURE__ */ React6.createElement(Text6, null, item.label.padEnd(8)), /* @__PURE__ */ React6.createElement(Text6, { color: theme.colors.primary }, "\u2588".repeat(barWidth)), /* @__PURE__ */ React6.createElement(Text6, { dimColor: true }, "\u2591".repeat(30 - barWidth)), /* @__PURE__ */ React6.createElement(Text6, { dimColor: true }, " ", item.value, "%"));
  })), /* @__PURE__ */ React6.createElement(Box6, { marginTop: 1 }, /* @__PURE__ */ React6.createElement(Text6, { dimColor: true }, "Platform usage distribution")));
};
var SettingsTab = () => {
  const theme = getTheme();
  const settings = [
    { key: "Notifications", value: "Enabled", icon: "\u{1F514}" },
    { key: "Theme Mode", value: "Auto", icon: "\u{1F3A8}" },
    { key: "Language", value: "English", icon: "\u{1F310}" },
    { key: "Privacy", value: "High", icon: "\u{1F512}" }
  ];
  return /* @__PURE__ */ React6.createElement(Box6, { flexDirection: "column" }, /* @__PURE__ */ React6.createElement(Text6, { bold: true, color: theme.colors.primary }, "Settings"), /* @__PURE__ */ React6.createElement(Box6, { marginTop: 1, flexDirection: "column" }, settings.map((setting, idx) => /* @__PURE__ */ React6.createElement(Box6, { key: idx }, /* @__PURE__ */ React6.createElement(Text6, { dimColor: true }, setting.icon, "  "), /* @__PURE__ */ React6.createElement(Text6, null, setting.key.padEnd(16)), /* @__PURE__ */ React6.createElement(Text6, { color: theme.colors.secondary }, setting.value)))), /* @__PURE__ */ React6.createElement(Box6, { marginTop: 1 }, /* @__PURE__ */ React6.createElement(Text6, { dimColor: true }, "Customize your preferences")));
};
...
var MultiSelect = ({
  ...
  const [confirmed, setConfirmed] = useState4(false);
  useInput3((input, key) => {
    if (key.upArrow) {
      setCursor((prev) => Math.max(0, prev - 1));
    } else if (key.downArrow) {
  ...
  return /* @__PURE__ */ React7.createElement(Box7, { flexDirection: "column" }, maxSelect > 0 && /* @__PURE__ */ React7.createElement(Box7, { marginBottom: 1, borderStyle: theme.borderStyle, borderColor: theme.colors.warning, paddingX: 1 }, /* @__PURE__ */ React7.createElement(Text7, { color: theme.colors.warning }, "\u26A0 Limit: Max ", maxSelect, " items")), /* @__PURE__ */ React7.createElement(Box7, { marginBottom: 1 }, /* @__PURE__ */ React7.createElement(Text7, { dimColor: true }, "Selected: "), /* @__PURE__ */ React7.createElement(Text7, { color: isLimitReached ? theme.colors.error : theme.colors.primary, bold: true }, checkedCount), /* @__PURE__ */ React7.createElement(Text7, { dimColor: true }, " / ", items.length)), showProgress && /* @__PURE__ */ React7.createElement(Box7, { marginBottom: 1 }, (() => {
    const barWidth = 30;
    const filled = Math.round(checkedCount / items.length * barWidth);
    const empty = barWidth - filled;
    return /* @__PURE__ */ React7.createElement(Box7, null, /* @__PURE__ */ React7.createElement(Text7, { dimColor: true }, "["), /* @__PURE__ */ React7.createElement(Text7, { color: theme.colors.primary }, "\u2588".repeat(filled)), /* @__PURE__ */ React7.createElement(Text7, { dimColor: true }, "\u2591".repeat(empty)), /* @__PURE__ */ React7.createElement(Text7, { dimColor: true }, "]"));
  })()), /* @__PURE__ */ React7.createElement(Box7, { marginBottom: 1 }, /* @__PURE__ */ React7.createElement(Text7, { color: theme.colors.border }, "\u2500".repeat(42))), /* @__PURE__ */ React7.createElement(Box7, { flexDirection: "column" }, items.map((item, index) => {
    const isCursor = index === cursor;
    const isChecked = checked.has(index);
    const isDisabled = isLimitReached && !isChecked;
    return /* @__PURE__ */ React7.createElement(Box7, { key: index }, /* @__PURE__ */ React7.createElement(Text7, { color: isCursor ? theme.colors.primary : theme.colors.text, bold: isCursor }, isCursor ? "\u25B8 " : "  "), /* @__PURE__ */ React7.createElement(
      Text7,
      {
    ...
    ), /* @__PURE__ */ React7.createElement(Text7, { dimColor: true }, item.desc || ""), isDisabled && /* @__PURE__ */ React7.createElement(Text7, { color: theme.colors.error }, " (Limit reached)"));
  })), /* @__PURE__ */ React7.createElement(Box7, { marginTop: 1 }, /* @__PURE__ */ React7.createElement(Text7, { color: theme.colors.border }, "\u2500".repeat(42))), confirmed && checkedCount > 0 ? /* @__PURE__ */ React7.createElement(Box7, { marginTop: 1 }, /* @__PURE__ */ React7.createElement(Text7, { color: theme.colors.success, bold: true }, "\u2713 Confirmed: ", items.filter((_, i) => checked.has(i)).map((i) => i.label).join(", "))) : confirmed && checkedCount === 0 ? /* @__PURE__ */ React7.createElement(Box7, { marginTop: 1 }, /* @__PURE__ */ React7.createElement(Text7, { color: theme.colors.warning, bold: true }, "\u26A0 Nothing selected")) : /* @__PURE__ */ React7.createElement(Box7, { marginTop: 1 }, /* @__PURE__ */ React7.createElement(Text7, { dimColor: true }, "Press Enter to confirm selection")), /* @__PURE__ */ React7.createElement(Box7, { marginTop: 1 }, /* @__PURE__ */ React7.createElement(Text7, { dimColor: true }, "Space Toggle   ", maxSelect === 0 && "a All   ", "n None   Enter Confirm")));
};
...
var Table = ({
  ...
  return /* @__PURE__ */ React8.createElement(Box8, { flexDirection: "column" }, /* @__PURE__ */ React8.createElement(Box8, null, columns.map((col, index) => /* @__PURE__ */ React8.createElement(
    Text8,
    {
      key: col.key,
  ...
  ))), /* @__PURE__ */ React8.createElement(Box8, null, columns.map((col, index) => /* @__PURE__ */ React8.createElement(Text8, { key: col.key, color: theme.colors.border }, "\u2500".repeat(col.width), index < columns.length - 1 && "\u2500\u253C\u2500"))), /* @__PURE__ */ React8.createElement(Box8, { flexDirection: "column" }, data.slice(scrollTop, endRow).map((row, displayIndex) => {
    const actualIndex = scrollTop + displayIndex;
    const isSelected = actualIndex === selected;
    const isEven = actualIndex % 2 === 0;
    return /* @__PURE__ */ React8.createElement(Box8, { key: actualIndex }, /* @__PURE__ */ React8.createElement(Text8, { color: isSelected ? theme.colors.primary : theme.colors.text, bold: isSelected }, isSelected ? "\u25B8 " : "  "), columns.map((col, colIndex) => {
  ...
  })), /* @__PURE__ */ React8.createElement(Box8, { marginTop: 1 }, /* @__PURE__ */ React8.createElement(Text8, { dimColor: true }, "Row ", selected + 1, " of ", data.length, "  \xB7  Showing ", scrollTop + 1, "\u2013", endRow)), /* @__PURE__ */ React8.createElement(Box8, { marginTop: 1 }, /* @__PURE__ */ React8.createElement(Text8, { dimColor: true }, "\u2191\u2193 Navigate   PgUp/PgDn Scroll   g Top   G Bottom   Enter Select")));
};

// src/components/registry.tsx
import React9 from "react";
var FileTreePreview = () => /* @__PURE__ */ React9.createElement(
  FileTree,
  {
    data: {
      name: "project",
...
var DataTreePreview = () => /* @__PURE__ */ React9.createElement(
  DataTree,
  {
    data: {
      name: "Root",
...
var TabPreviewContent = () => /* @__PURE__ */ React9.createElement(DashboardTab, null);
var TabsModernPreview = () => /* @__PURE__ */ React9.createElement(
  Tabs,
  {
    tabs: [
      { id: "tab1", label: "Tab 1", content: /* @__PURE__ */ React9.createElement(TabPreviewContent, null) },
      { id: "tab2", label: "Tab 2", content: /* @__PURE__ */ React9.createElement(TabPreviewContent, null) },
      { id: "tab3", label: "Tab 3", content: /* @__PURE__ */ React9.createElement(TabPreviewContent, null) }
    ],
    style: "modern"
  }
);
var TabsRoundedPreview = () => /* @__PURE__ */ React9.createElement(
  Tabs,
  {
    tabs: [
      { id: "tab1", label: "Tab 1", content: /* @__PURE__ */ React9.createElement(TabPreviewContent, null) },
...
var TabsPillsPreview = () => /* @__PURE__ */ React9.createElement(
  Tabs,
  {
    tabs: [
      { id: "tab1", label: "Tab 1", content: /* @__PURE__ */ React9.createElement(TabPreviewContent, null) },
...
var TablePreview = () => /* @__PURE__ */ React9.createElement(
  Table,
  {
    columns: [
...
var MultiSelectPreview = () => /* @__PURE__ */ React9.createElement(
  MultiSelect,
  {
    items: [
...
import React10, { useState as useState6, useEffect as useEffect2 } from "react";
...
var LoaderScreen = ({ onComplete }) => {
  ...
  return /* @__PURE__ */ React10.createElement(Box9, { flexDirection: "column", padding: 2, alignItems: "center", width: "100%" }, /* @__PURE__ */ React10.createElement(Box9, { justifyContent: "center", marginBottom: 2 }, /* @__PURE__ */ React10.createElement(Text9, null, gradient.pastel.multiline(`
\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2588\u2588\u2557\u2588\u2588\u2588\u2588\u2588\u2588\u2557 \u2588\u2588\u2588\u2588\u2588\u2588\u2557  \u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2588\u2588\u2588\u2557   \u2588\u2588\u2557
\u2588\u2588\u2554\u2550\u2550\u2550\u2550\u255D\u2588\u2588\u2551\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2554\u2550\u2550\u2550\u2550\u255D\u2588\u2588\u2588\u2588\u2557  \u2588\u2588\u2551
\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2588\u2588\u2551\u2588\u2588\u2551  \u2588\u2588\u2551\u2588\u2588\u2551  \u2588\u2588\u2551\u2588\u2588\u2551     \u2588\u2588\u2554\u2588\u2588\u2557 \u2588\u2588\u2551
\u255A\u2550\u2550\u2550\u2550\u2588\u2588\u2551\u2588\u2588\u2551\u2588\u2588\u2551  \u2588\u2588\u2551\u2588\u2588\u2551  \u2588\u2588\u2551\u2588\u2588\u2551     \u2588\u2588\u2551\u255A\u2588\u2588\u2557\u2588\u2588\u2551
\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2551\u2588\u2588\u2551\u2588\u2588\u2588\u2588\u2588\u2588\u2554\u255D\u2588\u2588\u2588\u2588\u2588\u2588\u2554\u255D\u255A\u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2588\u2588\u2551 \u255A\u2588\u2588\u2588\u2588\u2551
\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u255D\u255A\u2550\u255D\u255A\u2550\u2550\u2550\u2550\u2550\u255D \u255A\u2550\u2550\u2550\u2550\u2550\u255D  \u255A\u2550\u2550\u2550\u2550\u2550\u255D\u255A\u2550\u255D  \u255A\u2550\u2550\u2550\u255D
          `))), /* @__PURE__ */ React10.createElement(Box9, { justifyContent: "center", marginBottom: 1 }, /* @__PURE__ */ React10.createElement(Text9, { color: "cyan", bold: true }, "Terminal UI Component Library")), /* @__PURE__ */ React10.createElement(Box9, { justifyContent: "center", marginBottom: 2 }, /* @__PURE__ */ React10.createElement(Text9, { dimColor: true }, "Press Ctrl+C to exit anytime")), /* @__PURE__ */ React10.createElement(
    Box9,
    {
      flexDirection: "column",
      borderStyle: "round",
    ...
    /* @__PURE__ */ React10.createElement(Box9, { marginBottom: 1 }, /* @__PURE__ */ React10.createElement(Text9, { color: "green" }, /* @__PURE__ */ React10.createElement(Spinner2, { type: "dots" })), /* @__PURE__ */ React10.createElement(Text9, null, " "), /* @__PURE__ */ React10.createElement(Text9, null, status)),
    /* @__PURE__ */ React10.createElement(Box9, null, /* @__PURE__ */ React10.createElement(Text9, { color: "cyan" }, "["), /* @__PURE__ */ React10.createElement(Text9, { color: "green" }, "\u2588".repeat(filled)), /* @__PURE__ */ React10.createElement(Text9, { dimColor: true }, "\u2591".repeat(empty)), /* @__PURE__ */ React10.createElement(Text9, { color: "cyan" }, "]"), /* @__PURE__ */ React10.createElement(Text9, null, " "), /* @__PURE__ */ React10.createElement(Text9, { color: "yellow" }, progress, "%"))
  ));
};
...
var ShowcaseMenuScreen = ({ onSelect, onThemeSelect }) => {
  ...
  const items = [
    {
      ...
      subtitle: "[ Primary ]\nStyled variants",
      icon: "\u25C9",
      preview: /* @__PURE__ */ React11.createElement(SimpleButton, { label: "Primary" })
    },
    {
      id: "themes",
      title: "Themes",
      ...
      icon: "\u{1F3A8}",
      preview: /* @__PURE__ */ React11.createElement(Text10, { color: theme.colors.primary }, "6 Themes")
    },
    {
      id: "select",
      title: "Select",
      subtitle: "\u25B8 Option 1\nSingle-select",
      icon: "\u25B8",
      preview: /* @__PURE__ */ React11.createElement(Text10, null, "\u25B8 ", /* @__PURE__ */ React11.createElement(Text10, { color: theme.colors.primary }, "Option 1"))
    },
    {
      id: "multi-select",
      title: "Multi-Select",
      subtitle: "\u2611 Item A\nCheckboxes",
      icon: "\u2611",
      preview: /* @__PURE__ */ React11.createElement(Text10, null, /* @__PURE__ */ React11.createElement(Text10, { color: theme.colors.primary }, "\u2611"), " Item A\\n", /* @__PURE__ */ React11.createElement(Text10, { dimColor: true }, "\u2610"), " Item B")
    },
    {
      id: "text-input",
      title: "Text Input",
      subtitle: "\u2502 Type... \u2588\nLive typing",
      icon: "\u270E",
      preview: /* @__PURE__ */ React11.createElement(Text10, { dimColor: true }, "\u2502 Type... ", /* @__PURE__ */ React11.createElement(Text10, { color: theme.colors.primary }, "\u2588"))
    },
    {
      id: "trees",
      title: "Tree",
      subtitle: "\u251C\u2500 folder/\nHierarchy",
      icon: "\u{1F333}",
      preview: /* @__PURE__ */ React11.createElement(Text10, null, "\u251C\u2500 ", /* @__PURE__ */ React11.createElement(Text10, { color: theme.colors.primary }, "folder/"))
    },
    {
      id: "tabs",
      title: "Tabs",
      subtitle: "[ Tab 1 ]\nTab interface",
      icon: "\u229F",
      preview: /* @__PURE__ */ React11.createElement(Text10, null, "[ ", /* @__PURE__ */ React11.createElement(Text10, { color: theme.colors.primary, bold: true }, "Tab 1"), " ]")
    },
    {
      id: "tables",
      title: "Table",
      subtitle: "\u2502 Row 1 \u2502\nData grid",
      icon: "\u25A6",
      preview: /* @__PURE__ */ React11.createElement(Text10, { dimColor: true }, "\u2502 Row 1 \u2502")
    },
    {
      id: "cards",
      title: "Cards",
      subtitle: "\u250C\u2500Card\u2500\u2510\nPanel layout",
      icon: "\u25C8",
      preview: /* @__PURE__ */ React11.createElement(Text10, { dimColor: true }, "\u250C\u2500Card\u2500\u2510")
    },
    {
      id: "badges",
      title: "Badges",
      subtitle: "[ Active ]\nStatus tags",
      icon: "\u2666",
      preview: /* @__PURE__ */ React11.createElement(StatusBadge, { status: "success" })
    },
    {
      id: "progress",
      title: "Progress",
      subtitle: "[\u2588\u2588\u2588\u2588\u2591] 60%\nProgress bars",
      icon: "\u25AA",
      preview: /* @__PURE__ */ React11.createElement(LinearProgress, { value: 60, max: 100, animated: false })
    },
    {
      id: "spinners",
      title: "Spinners",
      subtitle: "\u280B Loading...\nAnimations",
      icon: "\u25CB",
      preview: /* @__PURE__ */ React11.createElement(Text10, null, /* @__PURE__ */ React11.createElement(Text10, { color: theme.colors.primary }, "\u280B"), " Loading...")
    },
    {
      id: "charts",
      title: "Chart",
      subtitle: "\u2582\u2583\u2585\u2587\u2586\u2584\u2582\nLive data",
      icon: "\u25A4",
      preview: /* @__PURE__ */ React11.createElement(Text10, { color: theme.colors.primary }, "\u2582\u2583\u2585\u2587\u2586\u2584\u2582")
    }
  ];
  useInput5((input, key) => {
  ...
  return /* @__PURE__ */ React11.createElement(Box10, { flexDirection: "column", padding: 2 }, /* @__PURE__ */ React11.createElement(
    Box10,
    {
      borderStyle: theme.borderStyle,
      borderColor: theme.colors.border,
    ...
    /* @__PURE__ */ React11.createElement(Text10, { bold: true, color: theme.colors.primary }, "siddcn Component Library Showcase")
  ), /* @__PURE__ */ React11.createElement(Box10, { marginBottom: 2, justifyContent: "center" }, /* @__PURE__ */ React11.createElement(Text10, { dimColor: true }, "Navigate the grid with arrow keys \xB7 Enter to explore")), /* @__PURE__ */ React11.createElement(Box10, { marginBottom: 2, justifyContent: "center", borderStyle: "round", borderColor: "yellow", paddingX: 2 }, /* @__PURE__ */ React11.createElement(Text10, { bold: true, color: "yellow" }, "\u{1F4A1} Press 'T' anytime for Theme Showcase (6 themes available)")), /* @__PURE__ */ React11.createElement(Box10, { flexDirection: "column" }, [0, 1, 2, 3].map((row) => /* @__PURE__ */ React11.createElement(Box10, { key: row, marginBottom: 1 }, [0, 1, 2].map((col) => {
    const index = row * 3 + col;
    if (index >= items.length) {
      return /* @__PURE__ */ React11.createElement(Box10, { key: col, width: 30 });
    }
    ...
    return /* @__PURE__ */ React11.createElement(
      ...
      /* @__PURE__ */ React11.createElement(Box10, { marginBottom: 0 }, /* @__PURE__ */ React11.createElement(Text10, { color: isSelected ? theme.colors.primary : theme.colors.text }, item.icon, "  ", /* @__PURE__ */ React11.createElement(Text10, { bold: true }, item.title))),
      /* @__PURE__ */ React11.createElement(Box10, { marginTop: 0 }, /* @__PURE__ */ React11.createElement(Text10, { dimColor: true }, item.subtitle))
    );
  })))), /* @__PURE__ */ React11.createElement(Box10, { marginTop: 2, justifyContent: "center" }, /* @__PURE__ */ React11.createElement(Text10, { dimColor: true }, items.length, " components \xB7 Arrow keys navigate \xB7 Enter select \xB7 Ctrl+C quit")));
};
